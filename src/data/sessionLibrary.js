...
export const SESSION_META = {
  ...
  SPEED_DAY: {
    ...
    prescription: [
      ...
      { title: '4 · Heavy lower (after the speed work)', body: 'Front squat 3–5 × 3–5 @ ≥80% 1RM (~3 min rest) · hamstring eccentric sliders 2–3 × 8 · one hinge accessory (B-stance RDL 2 × 8). Keep it tight — you’ve already sprinted & jumped; save the full prehab circuit for a separate day.' },
    ],
  ...
  STRENGTH_LOWER: {
    ...
    color: '#0ea5e9',
    icon: '🏋️',
    detail: 'Front-squat heavy anchor + your hamstring/groin/hip prehab circuit.',
    zone: null,
    prescription: [
      { title: 'Heavy anchor — Front squat', body: 'Your heavy bilateral lift: 3–5 × 3–5 @ ≥80% 1RM, ~3 min rest. Upright torso, crisp reps — this is what defends max force/RFD. See “This week” for the dose.' },
      { title: 'Eccentric hamstring — sliders', body: 'Hamstring eccentric sliders 2–3 × 8, lower as slowly as you can control. Your Nordic equivalent — non-negotiable hamstring insurance.' },
      { title: 'Hinge — B-stance RDL', body: 'B-stance DB RDL 2 × 8 (≈30 kg). Nudge load up across the block.' },
      { title: 'Unilateral — Bulgarian split squat', body: 'DB Bulgarian split squat 3 × 5 (≈30 kg). Add load as it gets easy.' },
      { title: 'Groin — Copenhagen', body: 'Copenhagen plank 2 × 30 s/side — adductor/groin protection.' },
      { title: 'Hip & calf', body: 'Side-lying hip-abduction iso 3 × 40 s · hip-flexor raise 3 × 8–10 (band or ≈40 kg cable) · standing calf iso 3 × 20 s (≈20 kg).' },
      { title: 'On Speed Day (Phase 2+)', body: 'After sprints + plyos, keep this to front squat + sliders + one accessory. Do the full circuit on a separate easy day if you want it all.' },
    ],
    why: '3–6 hard sets/wk >80% 1RM maintains and can build max strength on minimal time (§1.5). Heavy load preserves force/RFD; the eccentric hamstring + adductor work is the durability stack (§1.7).',
  },
  STRENGTH_UPPER: {
